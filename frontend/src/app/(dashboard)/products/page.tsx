...
export default function ProductsPage() {
  ...
  const [formData, setFormData] = useState<Partial<Product>>({ type: "Produit", vat_rate: 20 });
  ...
  const handleOpenModal = (mode: "create" | "edit", product?: Product) => {
    ...
    setFormData(product ? { ...product } : { type: "Produit", vat_rate: 20 });
    setIsModalOpen(true);
  };
  ...
  const handleCloseModal = () => {
    ...
    setFormData({ type: "Produit", vat_rate: 20 });
  };
